...
\begin{tikzpicture}[remember picture,overlay]
  ...
  {\begin{tikzpicture}[remember picture,overlay]
      ...
      \draw[anchor=north] (midpoint) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering \cDarkGrey{Computer Systems \large{A Programmer's Perspective}}\\[15pt] % Book title
          {\cDarkGrey{\Large by q00148943}}\\[20pt] % Subtitle
