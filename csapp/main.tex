...
\begin{tikzpicture}[remember picture,overlay]
  ...
  {\begin{tikzpicture}[remember picture,overlay]
      ...
      \draw[anchor=north] (midpoint) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering \cDarkGrey{Computer Systems: A Programmer's Perspective}\\[15pt] % Book title
          {\cDarkGrey{\huge by q00148943 : \texttt{v42.org}}}\\[20pt] % Subtitle
          {\cDarkGrey{\large Updated: \today}}}}; 
    \end{tikzpicture}};
\end{tikzpicture}
\vfill
\endgroup
...
\subfile{c-limitproperties}
\subfile{c-calculusrules}

\part{Algebra}
\subfile{algebra-simplify-univariatepolynomials}
\subfile{algebra-simplify-multivariatepolynomials}
\subfile{algebra-simplify-factoringunivariatetrinomials}
